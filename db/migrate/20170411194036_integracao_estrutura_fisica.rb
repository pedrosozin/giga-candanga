class IntegracaoEstruturaFisica < ActiveRecord::Migration[5.0]
  ...
  #   end
  #   add_index :sites, :instituicao_id

  #   create_table :geradores do |t|
  #     t.string :fabricante
  #     t.integer :potencia
  ...
  #     t.integer :switch_id
  #   end
  #   add_index :slots, :switch_id

  #   create_table :portas_slot do |t|
  #    t.string :porta
  #    t.string :tipo
  #    t.integer :slot_id
  #   end
  #   add_index :portas_slot, :slot_id

  #   create_table :gbics do |t|
  #     t.string :serie
  #     t.string :patrimonio
  #     t.string :tipo
  #   end
